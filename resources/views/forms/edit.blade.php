<x-app-layout>
    ...
    <!-- Inject pre-populated fields list to global script window scope -->
    <script>
        window.prePopulatedFields = @json($form->fields ?? []);
    </script>
                    ...
                    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="title" required value="{{ $form->title }}" placeholder="e.g., Lead Contact Form" class="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 py-2.5 px-3.5 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="status" class="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 py-2.5 px-3.5 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors">
                                    <option value="active" {{ $form->status === 'active' ? 'selected' : '' }}>Active (Accepting Submissions)</option>
    ...
    <script>
        function formBuilder() {
            return {
                ...
                formActionUrl: "{{ route('forms.update', $form->id) }}",
